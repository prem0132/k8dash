...
export default class Knerrir extends Base {
    ...
    render() {
        const {cronJobs, daemonSets, deployments, jobs, statefulSets, knerrir, sort, filter} = this.state;
        const items = [cronJobs, daemonSets, deployments, jobs, statefulSets, knerrir];
