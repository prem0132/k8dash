...
import SparkApplication from './views/sparkApplication';
import SparkApplications from './views/sparkApplications';
...
registerRoute('/sparkapplication', () => <SparkApplications />);
registerRoute('/sparkapplication/:namespace/:name', params => <SparkApplication {...params} />);
