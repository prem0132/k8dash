    ...
    return (
      <>
        <div
          className={
            toggled
              ? "menu_background menu_backgroundToggled"
              : "menu_background"
          }
          onClick={onClick}
        />
        ...
        <div id="menu" className={toggled ? "menu_toggled" : undefined}>
          ...
          <Group>
            ...
            <MenuItem
              ...
              path="rolebinding"
              resource="Role"
              additionalPaths={["clusterrolebinding"]}
              onClick={onClick}
            />
            <MenuItem
              title="Secrets"
          ...
          <Group>
            <div className="menu_itemApply">
              <button
                className="menu_item button_clear"
                onClick={() => {
...
function MenuItem(item) {
  ...
  const className = paths.includes(currentPath)
...
function Group({ children = [] }) {
  ...
  return (
    <div className="menu_group">
      ...
      <div
        className={
          isSelected ? "menu_subMenu menu_subMenuSelected" : "menu_subMenu"
        }
      >
        {children.slice(1)}
      </div>
